...
# This code is by Steve Harris (steve@plugin.org.uk);
# it generates ladspa plugins from XML files. This is a modified
# version for generated plugins to be statically linked - it requires
# a meta "fileid" to generate a unique descriptor get function.


# this was originally List::Util, but any (on my machine at least)
# is in MoreUtils.
...
$xmlp = new XML::Parser(Style => 'Tree', 
                        ParseParamEnt => 1, ErrorContext => 3, NoLWP => 1);
